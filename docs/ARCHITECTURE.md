...
The public project API is implemented by the canonical class, represented machine-readably by `standards/api/public-api.json`, and documented for users in `docs/COMMAND-REFERENCE.md`.
