...
Updated: 2026-09-04
Status: DRAFTED BY REGRESSION AUDIT
...
**Acceptance:** static contract green; full Linux PR integration green; no unknown phase consumers; article source rules remain source-review-only before the Scientific Article phase.
...
**Acceptance:** rule IDs no longer use ambiguous `caption` semantics for two different typographic elements; final-PDF measurement proves the accepted title/source/legend sizes and single spacing; review examples match the new contract.
...
**Acceptance:** canonical annex demonstrates `Fonte:`; automated back-matter checks remain green; rendered TOC and heading styling pass visual inspection.
...
| 19 | PARTIAL | P1 | Add page/locator in long direct-quote examples when source supports it. | Citation fixture. |
| 20 | PARTIAL | P1 | Add explicit fixture for punctuation immediately before parenthetical long-quote citation. | Negative/positive citation fixture. |
...
| 23 | PARTIAL | P1 | Demonstrate/validate source page locator when applicable. | Documentary-source fixture. |
