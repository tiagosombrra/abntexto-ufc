...
Canonical R2-B3 entry checkpoint on `main`: `0650845b922271fc134d20ef2a8c36ebb999ef91`. Certified R1 product candidate: `9b1752565ac217c04ffa22a9ef272cdf078af380`.
...
| R2-B2 | DONE | issue #237; PR #242 → `8e3e0f2a165e488a00f08a0031ba6fb4a01f9949`; closeout PR #243 → `0650845b922271fc134d20ef2a8c36ebb999ef91` | Academic/front-matter rendering API directly owned; integration `30/0/0`, closeout integration `30/0/0`, merged-main release gate `32/0/0`, late CTAN/bundle source audit PASS | None |
| R2-B3 | ACTIVE | issue #238; entry `0650845b922271fc134d20ef2a8c36ebb999ef91` | Structural/object environments, optional object API, extension hooks and project-owned object IDs | Direct ownership, atomic consumer migration and validation |
