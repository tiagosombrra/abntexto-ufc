...
Every material repository advance updates affected documentation and machine state in the same work cycle. No build, tag or submission is treated as CTAN acceptance without explicit external evidence.