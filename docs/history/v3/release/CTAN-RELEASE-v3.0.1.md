> **Historical snapshot.** This is the v3.0.1 publication guide retained during the v3.0.2 release-state cleanup. It is not current release authority. Original path: `docs/CTAN-RELEASE.md`.
