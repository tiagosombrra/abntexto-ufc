> **Historical snapshot.** Relocated during the v3.0.2 document-lifecycle cleanup. This file is retained as audit evidence and is not current control-plane authority. Original path: `docs/R3-HARDENING-INVENTORY.md`. Current authority: `docs/V3.0.2-REPOSITORY-HYGIENE-STATUS.md`.
