> **Historical snapshot.** Retained from branch `plan/post-v3.0.1-regression-audit` during the v3.0.2 repository-hygiene audit. It is not current control-plane authority. Current hygiene status: `docs/V3.0.2-REPOSITORY-HYGIENE-STATUS.md`. Original path: `docs/POST-V3.0.1-REGRESSION-PLAN.md`.
