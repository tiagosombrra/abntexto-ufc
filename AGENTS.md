...
- V3-R3 is DONE. R3-A/#250 and R3-B1 through R3-B5 are complete; `docs/R3-HARDENING-INVENTORY.md` and `release/v3-r3-inventory.json` preserve the closed sequence. V3-R4/#267 is technically certified on `c79f3c73f1d51a30175e8259269504d029442a1c` by run `33855800767` and remains ACTIVE only for exact R5 entry closeout; V3-R5/#272 is PREPARED/BLOCKED.
