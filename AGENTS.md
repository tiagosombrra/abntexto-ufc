...
- V3-R3, V3-R4, V3-R5 and V3-A1 are DONE. A1/#275 source contract merged through PR #279 at `4d018a92697e8f39e3a53b034c451e55996c84fb` and closed through PR #281 at exact A2 predecessor `7a7562d23e8bf6c92abb635718639d617a2ed6ff`. V3-A2/#280 is ACTIVE from that SHA; the canonical `scientific-article` runtime/profile-matrix lot has started. A2 must reuse cross-cutting infrastructure, preserve modality, and require article-specific evidence before proof promotion.
