...
- R3-B1/#252 is DONE through PR #258 at `afb9f16403aafd8752a0aa8b0713f85c41204d1b`. Static `33758758911` and Linux `33758758877` passed, with Linux `PASS=30 FAIL=0 SKIP=0`; the deliberate front-matter negative fixture was rejected on `dedication.position.start`. R3-B2/#253 is ACTIVE; B3/#254, B4/#255, and B5/#256 remain ordered and pending.
