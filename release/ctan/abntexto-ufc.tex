...
The canonical package archive is \texttt{abntexto-ufc-3.0.0.zip}. It is the single archive intended for CTAN submission and contains one top-level \texttt{abntexto-ufc/} directory. Its only runtime implementation file is the generated monolithic \texttt{abntexto-ufc.cls}; the remaining files are README, CHANGELOG, license, this manual and the minimal example in source/PDF form.
