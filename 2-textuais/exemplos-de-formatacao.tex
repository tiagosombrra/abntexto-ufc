...
O Gráfico~\ref{graf:barras} valida a numeração de gráficos e sua presença na Lista de Ilustrações. O exemplo é desenhado diretamente em \LaTeX{}, com eixos, categorias, escala e valores explícitos, evitando dependência de um arquivo raster para esta validação visual.
