...
\section{Citações bibliográficas}\label{sec:citacoes}
    ...
    Esta frase mostra como citar um livro sobre descargas atmosféricas \cite{rakov2003lightning}. Também podem ser citados \textit{sites} como \citeonline{elat2015densidade}. As referências são cadastradas no arquivo \texttt{3-pos-textuais/referencias.bib}. O template utiliza \texttt{biblatex-abnt} com Biber; prefira \verb|\textcite| e \verb|\parencite|, mantendo-se \verb|\cite| e \verb|\citeonline| por compatibilidade.        
    ...
    Referenciando outro site \cite{secretaria1999}. Texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto. Texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto. Texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto. Texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto. Citando uma norma \cite{NBR10520:2023}.
...
\section{Inserindo figuras}\label{sec:figuras}
    ...
    % Prefira [htbp] para permitir posicionamento tipográfico adequado.
    \begin{figure}[htbp]
        \centering
        \UFCfig{
            \Caption{\label{fig:reitoria} Fotografia da reitoria da Universidade Federal do Ceará}
        }{
            \UFCincludegraphics[width=\linewidth]{exemplo-1}
        }{
	...
	\begin{figure}[htbp]
        ...
        \UFCfig{
            ...
            \UFCincludegraphics[width=.88\linewidth]{sondas}
        }{
	...
	\begin{table}[htbp]
        ...
        \UFCtab{
            ...
            \begin{abnttblr}[]{
                ...
                João da Silva & 22/02/2222 & 222.222.222-22 \\
                Ana da Silva & 03/03/3333 & 333.333.333-33 \\
            \end{abnttblr}
        }{
            \Fonte{Elaborada pelo autor.}
            \Nota{Dados apresentados apenas para demonstrar a composição da tabela.}
        }
    \end{table}
...
\subsection{Uso de siglas} \label{sec:siglas}
    ...
    Para utilizar siglas, primeiro abra o arquivo dedicado à lista de abreviaturas e siglas na pasta \texttt{1-pre-textuais} e use o comando 
    \begin{verbatim}
\newacronym{ABNT}{ABNT}
...
\gls{ABNT}
    \end{verbatim}
    Fica assim: \gls{ABNT}. A primeira vez que o comando é usado para uma determinada sigla, aparece o significado por extenso da sigla com a sua abreviação em seguida. A partir da segunda vez que o comando para uma determinada sigla é usado, aparece apenas a sigla. Por exemplo: \gls{ABNT}.  
    
    Veja o código fonte de outros exemplos: Teste de siglas \gls{TEST}, outros exemplos de siglas: \gls{DA}, \gls{MCEG}. 
    Repare que as siglas são sempre definidas previamente nesse arquivo.