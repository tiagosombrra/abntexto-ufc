...
\guiaexemplo{A ficha catalográfica está desativada no documento principal para demonstrar a política padrão do perfil. O comando correspondente permanece comentado em \texttt{documento.tex} e pode ser habilitado quando o fluxo institucional exigir sua representação.}
...
\guianormativa{ABNT NBR 6034:2004}{O índice remissivo é um elemento pós-textual opcional. No documento de referência ele permanece habilitado para demonstrar o recurso e validar sua apresentação.}
