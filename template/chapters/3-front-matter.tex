...
Nos perfis acadêmicos aos quais se aplica, a folha de aprovação registra autoria, título, natureza do trabalho, data de aprovação, orientação e banca examinadora. O TCC canônico usa três membros na banca: orientador e dois examinadores.
...
\guiamecanismo{Declare em \texttt{\string\ufcsetup} somente os membros efetivos da banca e gere a página com \texttt{\string\ufcPrintApprovalPage}. O TCC canônico deixa os campos de unidade/departamento da banca vazios, mantendo apenas nome e instituição para o orientador e os dois examinadores.}
