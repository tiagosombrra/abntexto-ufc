...
\guianormativa{ABNT NBR 6034:2004}{O índice remissivo é um elemento pós-textual opcional. A classe mantém suporte ao recurso, mas o TCC canônico não imprime um índice remissivo; a Seção~\ref{sec:recursos-finais} documenta como habilitá-lo quando pertinente \parencite{abnt6034}.}
