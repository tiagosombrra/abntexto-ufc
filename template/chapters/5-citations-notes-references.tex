...
\guiamecanismo{A API bibliográfica exercitada pelo projeto oferece \texttt{\string\apud[localizador-original]\{fonte-original\}[localizador-consultado]\{fonte-consultada\}} e \texttt{\string\textapud\{fonte-original\}\{fonte-consultada\}}. As duas chaves precisam existir na base bibliográfica para que o sistema tenha os metadados necessários, mas a lista final deve refletir corretamente a fonte efetivamente consultada.}
...
\guiamecanismo{Declare o banco com \texttt{\string\ufcAddBibliographyResource\{backmatter/references.bib\}} e gere a lista final com \texttt{\string\ufcPrintReferences}. O fluxo de compilação do projeto executa Biber automaticamente quando o arquivo de controle indicar fontes bibliográficas.}
