...
A opção \texttt{font=times|arial} seleciona a família textual desejada. A opção \texttt{fonte-estrita} determina se a identidade literal é obrigatória ou se o ambiente pode usar fallback portátil.
