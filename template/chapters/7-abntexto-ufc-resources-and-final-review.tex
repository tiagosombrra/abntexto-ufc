\chapter{Recursos do abntexto-ufc, elementos pós-textuais e revisão final}\label{sec:recursos-finais}
...
\section{Fontes e motores de compilação}
...
\section{Tabelas, códigos, algoritmos e equações}
...
\section{Acessibilidade e limites de conformidade}
...
\section{Compilação reprodutível do projeto}
...
\section{Checklist antes da entrega}
