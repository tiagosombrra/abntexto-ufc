...
\guiamecanismo{No primeiro grupo, \texttt{type} seleciona o perfil, \texttt{print-mode} controla impressão em anverso ou frente e verso, e opções como \texttt{cover}, \texttt{catalog-card}, \texttt{font}, \texttt{strict-font}, \texttt{tables}, \texttt{code}, \texttt{algorithms} e \texttt{glossary} selecionam comportamentos ou módulos. O índice remissivo é opcional e pode ser habilitado posteriormente com \texttt{index=imakeidx} quando for pertinente ao trabalho.}
