...
\guiaexemplo{Este PDF está configurado em \texttt{print-mode=single-sided}. A matriz de testes do projeto também compila cenários frente e verso para verificar margens espelhadas, paginação e início em página apropriada.}
