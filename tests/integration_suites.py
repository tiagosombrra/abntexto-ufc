...
SUITES: dict[str, tuple[str, ...]] = {
    ...
    "web-lite": ("validator-source", "reference"),
    "article": (
...
PATH_RULES: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    ("web-lite", ("validator/", "tools/build-validator-site.py", "tests/checks/validator_source.py", "tests/integration/web-lite-browser-e2e.py")),
)
...
def self_test() -> None:
    cases = {
        ...
        ("validator/validation-contract.json",): ("web-lite",),
        ("tools/build-validator-site.py",): ("web-lite",),
        ("tests/checks/validator_source.py",): ("web-lite",),
        ("tests/integration/web-lite-browser-e2e.py",): ("web-lite",),
