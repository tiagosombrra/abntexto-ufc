...
CHECKS = (
    ...
    Check("pdf-validator", "UFC PDF validator", ("sh", "tests/v2-pdf-validator-check.sh", "main.pdf"), depends=("reference",)),
    Check("pdfa", "Reference PDF/A-2b", ("sh", "tests/v2-pdfa-check.sh", "main.pdf"), modes=("release",), depends=("reference",)),
    ...
    Check("article-runtime", "Scientific article runtime", ("sh", "tests/v2-article-check.sh")),
    Check("profiles", "Document profiles", ("sh", "tests/v2-profile-matrix-check.sh"), depends=("article-runtime",)),
