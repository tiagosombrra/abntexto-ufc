...
CHECKS = (
    ...
    Check("distribution-source", "Distribution source", ("sh", "tests/v2-distribution-check.sh"), depends=("repository",)),
    ...
    Check("normative-complement", "Normative complement", ("sh", "tests/v2-normative-complement-check.sh"), depends=("math",)),
    ...
    Check("objects", "Academic objects", ("sh", "tests/v2-object-check.sh"), depends=("object-geometry", "code-typography", "table-ibge")),
    ...
    Check("bibliography", "Bibliography", ("sh", "tests/v2-bibliography-check.sh"), depends=("documentary-source",)),
    Check("reference-spacing", "Reference spacing", ("sh", "tests/v2-reference-spacing-check.sh"), depends=("bibliography",)),
