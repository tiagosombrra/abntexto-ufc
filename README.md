...
Para um exemplo completo, use `template/main.tex`. Nos bundles de Template e Overleaf, a mesma fonte pública vem acompanhada de `abntexto-ufc-reference.pdf`, um guia pedagógico completo de 63 páginas na certificação da versão 3.0.1.
