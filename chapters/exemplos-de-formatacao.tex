...
\begin{ufcobjeto}[here]
  \centering
  \includegraphics[width=0.65\linewidth]{figures/fluxo-exemplo.png}
\end{ufcobjeto}
...
\ufcnota{Fotografia externa usada sem modificação e distribuída sob licença própria; ver \texttt{figures/LICENCAS.md}.}
...
\begin{ufcobjeto}[here]
  \ufcinputlisting[language=Python,numbers=left,numbersep=8pt]{figures/exemplo.py}
\end{ufcobjeto}
